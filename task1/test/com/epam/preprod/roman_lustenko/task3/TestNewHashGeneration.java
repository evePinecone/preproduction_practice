...
import com.epam.preprod.roman_lutsenko.task3.StringFourHashWrapper;
import com.epam.preprod.roman_lutsenko.task3.StringLengHashWrapper;
...
public class TestNewHashGeneration {
	...
	public void init() {
		...
		hashMapLengKey.put(new StringLengHashWrapper("4"), new FitnessBraslet());
		...
		linkedHashMapLengKey.put(new StringLengHashWrapper("4"), new FitnessBraslet());
