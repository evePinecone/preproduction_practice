               ...
               <%@include file="WEB-INF/jspf/header.jspf"%>
				<div id="banner">
					<section class="container">
						<h2>Pinecone SHOP</h2>
						<span>Design by Templated&Eve</span>
						<p>Our products are all what you need</p>
					</section>
				</div>
			...
			<div class="wrapper style2">
				<section class="container">
					<div class="row double">
						<div class="6u">
							<header class="major">
								<h2>We introduce to you unique and authentic gadgets</h2>
		...
		<!-- Section Two -->
			<div class="wrapper style3">
				<section class="container">
					...
					<p>Our masters create all items with true love and victim to bring to you a greatful things. Each of them have his unique style of implementation. Every item has one and only punch line</p>
					<a href="#masters_list" class="button alt">Our masters</a>
				</section>
			</div>
